...
<html>
	...
	<body>
		...
		echo "<tr><th>Nombre</th><th>Descripción</th><th>Modelo</th><th>Precio*</th><th>IVA</th><th>Stock</th><th>Comprar</th></tr>";
		foreach($productos as $producto){
			...
			$iva = $producto['iva'];
			$precio = $producto['precioUnitario'] * ($iva / 100);
			...
			echo "<tr>
				...
				<td> 
					<form action = 'anadir.php' method = 'POST'>
						...
						<input name = 'cod' type='hidden' value = '$idProducto'>
